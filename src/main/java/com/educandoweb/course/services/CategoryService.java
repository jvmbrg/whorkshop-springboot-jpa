...
/* Aqui no pacote serviços temos a classe CategoryService que é responsavel por gerir os servi
...
public class CategoryService {
	...
	public Category findById(Long id) {
		...
		return obj.get(); // o metodo get retorna um objeto do tipo Category que estiver dentro do Optional.
	}
}
